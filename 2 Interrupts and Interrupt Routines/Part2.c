...
char RedGreen = 0;                                 //Global Variable to track whether the Led is Green or Red
int main(void)
{
...
__interrupt void Port_2(void)
{
    ...
    if(ToggleEnable)
    RedGreen ^= 0x01;                         //When Button is Pressed RedGreen will Toggle
}
